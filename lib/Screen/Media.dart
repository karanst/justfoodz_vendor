...
import 'package:ziberto_vendor/Model/Media_Model.dart';
            ...
            ? TextButton(
                onPressed: () {
                  if (widget.from == "other") {
                    ...
                    Navigator.pop(context,[otherPhotos,otherImageUrl]);
        ...
        onTap: () {
          setState(() {
            ...
            if (widget.from == "main") {
              ...
              Navigator.pop(context,[productImage,productImageUrl]);
            } else if (widget.from == "video") {
              uploadedVideoName =
                  mediaList[index].subDic! + "" + mediaList[index].name!;
              Navigator.pop(context,[uploadedVideoName]);
           ...
           //   Navigator.pop(context,[otherImgList,otherImgUrlList]);
            } else if (widget.from == 'variant') {
              if (mediaList[index].isSelected) {
                variantImgList.add(
                    mediaList[index].subDic! + "" + mediaList[index].name!);
