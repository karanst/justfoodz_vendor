...
import 'package:ziberto_vendor/Model/Customer/CustomerModel.dart';
...
//============================ AppBar ==========================================
  ...
  AppBar getAppbar() {
    return AppBar(
      ...
      iconTheme: IconThemeData(color: AppColor().colorBg1()),
                  ...
                  if (iconSearch.icon == Icons.search) {
                    ...
                    appBarTitle = TextField(
                      ...
                      decoration: InputDecoration(
                        prefixIcon: Icon(Icons.search, color: AppColor().colorBg1()),
                        hintText: getTranslated(context, "Search")!,
                        hintStyle: TextStyle(color: AppColor().colorBg1()),
                      ),
